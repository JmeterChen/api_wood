...
class Delete_file(unittest.TestCase):
    ...
    url_workid = 'https://api.maocode.cn/tiger/wood/user/works?page=1&limit=15&language_type=0'
    ...
    def test_21_delete_file01(self):
        ...
        if len(result_workid_list) >= 2:
            for i in range(2):
                ...
                url = "https://api.maocode.cn/tiger/work/" + result_workid + "/permanently"
    ...
    def test_22_delete_file02(self):
        """ 正常登录态- 删除早已删除作品"""
        url = "https://api.maocode.cn/tiger/work/" + '3352256' + "/permanently"
    ...
    def test_23_delete_file03(self):
        """ 正常登录态- 删除不存在作品"""
        url = "https://api.maocode.cn/tiger/work/" + '0000000' + "/permanently"
        res = requests.delete(url=url, headers=self.headers)
    ...
    def test_24_delete_file04(self):
        """ 正常登录态- 删除不符合规则作品"""
        url = "https://api.maocode.cn/tiger/work/" + 'aaaaaaa' + "/permanently"
        res = requests.delete(url=url, headers=self.headers)
    ...
    def test_25_delete_file05(self):
        ...
        url = "https://api.maocode.cn/tiger/work/" + '2287499' + "/permanently"
        res = requests.delete(url=url, headers=headers)
        self.assertEqual(res.status_code, 403)
